...
import com.thymeleafspringlearningudemy.thymeleafspringlearningudemy.services.DepartamentoService;
...
public class CargoController {
	...
	public String listar(ModelMap model,
		...
		PaginationUtil<Cargo> pageCargo = cargoService.buscarPorPagina(paginaAtual, ordem);
